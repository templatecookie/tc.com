                    ...
                    <div class="px-4 w-9/12 flex flex-wrap h-auto border-l border-gray-100">
                        ...
                        <aside class="w-4/12 lg:flex lg:flex-col">
                            <div class="sticky top-16">
                                ...
                                <nav class="mt-4">
                                    <!-- <ul class="mb-2">
                                                    <li @click="tableOfContentsHeadingClick(link)" class="toc-list"
                                                        :class="{ 'pl-4': link.depth === 3}" v-for="link of item.toc" :key="link.id">
                                                        <a role="button"
                                                            class="transition-colors duration-75 mb-2 block text-gray-700 font-light text-sm"
