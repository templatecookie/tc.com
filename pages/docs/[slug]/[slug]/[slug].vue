          ...
          <div class="px-4 w-4/12 h-auto border-l border-gray-100">
            <aside class="col-span-1 lg:flex lg:flex-col">
              <div class="sticky top-16">
                ...
                <nav class="mt-4">
                  <ul class="mb-2">
                    <li @click="tableOfContentsHeadingClick(link)" class="toc-list" :class="{ 'pl-4': link.depth === 3}"
                      v-for="link of page" :key="link.id">
                      <a role="button" class="transition-colors duration-75 mb-2 block text-gray-700 font-light text-sm"
