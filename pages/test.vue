        ...
        <div class="px-4 mb-6 sm:px-6 sm:text-center md:mx-auto lg:col-span-6 lg:flex lg:items-center lg:text-center">
          <div>
            ...
            <p data-aos="fade-up" data-aos-delay="300"
              class="mt-3 text-base text-gray-300 sm:mt-5 sm:text-xl lg:text-lg md:max-w-2xl mx-auto">Templatecookie have
              a talented and experienced team of designers and developers who are committed to offering the best value to
              your projects. </p>
          </div>
        </div>
