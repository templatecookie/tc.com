<template>
  <div class="bg-gray-900" :id="id">
    <div class="relative overflow-hidden pt-24 pb-96 lg:pt-32">
      <div><img class="absolute bottom-0 left-1/2 w-full max-w-none -translate-x-1/2" src="/grid-blur-purple-on-black.jpg"
          alt="Teplatecookie Pricing Section Background" /></div>
        ...
        <div class="mx-auto max-w-md lg:max-w-4xl">
          <div
            ...
            <div class="lg:min-w-0 lg:flex-1">
              ...
              <div class="mt-2 text-base leading-7 text-gray-600">
                We designed our product with the most adaptable system and features that may be altered in accordance with
                your unique company requirements. Our talented and knowledgeable developers are prepared to implement all
                the adjustments you require for your company.
              </div>
            </div>
            <div>
