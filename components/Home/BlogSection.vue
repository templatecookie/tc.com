  ...
  <div class="relative bg-gray-50 -mb-20">
    <div class="relative mx-auto max-w-7xl py-20 sm:py-24 lg:py-32 px-4 sm:px-6 lg:px-8">
      <div class="text-center">
        <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl aos" data-aos="flip-up">From the blog</h2>
        <p class="mx-auto mt-3 max-w-2xl text-xl text-gray-500 sm:mt-4 aos" data-aos="flip-up" data-aos-delay="100">Learn more
      ...
      <div class="mx-auto mt-12 grid gap-5 lg:max-w-none sm:grid-cols-2 lg:grid-cols-3">
        <blog-item class="aos" data-aos="fade-up" :data-aos-delay="index * 100" :item="item" v-for="(item, index) in data"
          :key="index" />
      </div>
